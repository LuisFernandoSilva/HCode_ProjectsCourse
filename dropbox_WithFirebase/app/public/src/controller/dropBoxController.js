...
class DropBoxController {
    ...
    //usa o real e o storage do firebase
    connectFirebase() {
    //config firebase
  
    }
    //retorna todos itens selecionados
    getSelection() {
    ...
    //pegar a referencia no firebase para acessar e colocar os arquivos nas coleçoes
    getFirebaseRef(path) {
    ...
    //controla o modal do progresss
    modalShow(show = true) {
      this.snackModalEl.style.display = show ? "block" : "none";
    }
    //retorna uma promisse ligando o servidor ao firebase e a atualização de tela com as rotas
    ajax(
      url,
      method = "GET",
    ...
    //altera o modal da barra de progresso conforme o time de download do arquivo
    ...
    //formado timestamp para horas e mostrar na barra de progresso
    ...
    //para determinar tipo de arquivo e icon, assim como lista os arquivos
    ...
    // para ver qualquer alteração no firebase
    readFiles() {
    ...
    //evento para selecionar um dos itens com ctrl e shift e um evento personalizado
    initEventsLi(li) {
